CREATE TABLE `ride`
(
    `ride_seq`  int         NOT NULL AUTO_INCREMENT COMMENT '놀이기구 순번',
    `ride_name` varchar(50) NOT NULL COMMENT '놀이기구 이름',
    ...
    PRIMARY KEY (`ride_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='놀이기구';

CREATE TABLE `pass`
(
    `pass_seq`        int         NOT NULL AUTO_INCREMENT COMMENT '이용권 순번',
    `ride_seq`        int         NOT NULL COMMENT '놀이기구 순번',
